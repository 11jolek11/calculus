...
# Works:
    ...
    def calculate(self):
        ...
        submit_button = Button(self.root, text="Submit", command=calculate)
        ...
        # self.label = Label(root, text="Th== is our first GUI!")
        # self.label.pack()
        #
        # self.greet_button = Button(root, text="Greet", command=self.greet)
        # self.greet_button.pack()
        #
        self.close_button = Button(self.root, text="X", command=self.root.quit, bg = "red")
